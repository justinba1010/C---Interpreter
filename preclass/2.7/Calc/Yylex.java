...
"0:9,9:2,0,9:2,0:18,9,0:7,2,3,6,4,0,5,0,7,8:10,0:57,1,0:65420,10:2")[0];

	private int yy_rmap[] = unpackFromString(1,13,
"0,1:6,2,1:3,3,4")[0];

	private int yy_nxt[][] = unpackFromString(5,11,
"-1,11,1,2,3,4,5,6,7,8,9,-1:19,7,-1:4,10,-1:18,9");
