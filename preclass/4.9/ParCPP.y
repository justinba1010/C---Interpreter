...
Exp16 :: { Exp }
Exp16 : Exp15 '[' Integer ']' { AbsCPP.EIndex $1 $3 }
      | '*' Exp15 { AbsCPP.EDeref $2 }
      | '&' Exp15 { AbsCPP.EAddr $2 }
      | '(' Exp ')' { $2 }
Exp15 :: { Exp }
...
Exp2 :: { Exp }
Exp2 : Exp2 '=' Exp3 { AbsCPP.EAss $1 $3 } | Exp3 { $1 }
Exp :: { Exp }
Exp : Exp1 { $1 }
Exp1 :: { Exp }
Exp1 : Exp2 { $1 }
...
ListExp : {- empty -} { [] }
        ...
        | Exp ',' ListExp { (:) $1 $3 }
Type :: { Type }
Type : Type '[]' { AbsCPP.Tarr $1 }
     | Type '[' Integer ']' { AbsCPP.Tarrs $1 $3 }
     | '&' Type { AbsCPP.Taddress $2 }
     | Type '&' { AbsCPP.Taddress $1 }
     | '*' Type { AbsCPP.Tpointer $2 }
     | Type '*' { AbsCPP.Tpointer $1 }
     | 'bool' { AbsCPP.Tbool }
