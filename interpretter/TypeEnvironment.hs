...
lookUpVar (_, []) id = Bad "TYPECHECKER ERROR: Empty context stack"
...
lookUpFunc (_,[]) id = Bad "TYPECHECKER ERROR: Undefined behavior, empty context stack"
